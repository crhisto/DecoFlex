...
```{r}
save(list = ls(all.names = TRUE, name = environment()), file = "/Users/crhisto/Documents/GitHub/DecoFlex/DecoFlexR/vignettes/figures_manuscript/backup/environment_25_10_2023.RData")
```
